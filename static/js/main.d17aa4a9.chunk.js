(this["webpackJsonpfrontend-test-boilerplate"]=this["webpackJsonpfrontend-test-boilerplate"]||[]).push([[0],{26:function(e,t,a){e.exports=a(41)},31:function(e,t,a){},41:function(e,t,a){"use strict";a.r(t);var n=a(0),r=a.n(n),i=a(12),o=a.n(i),l=(a(31),a(14)),s=a(21),c=a(10),d=a(7),m=a(5),h=(a(33),a(1));var u,p,b,f,v,g,w,E,y,j,O,B,x,M=new class{constructor(e){this.DB_NAME=void 0,this.DB_STORE=void 0,this.VERSION=void 0,this.DB=void 0,this.init=()=>new Promise((e,t)=>{const a=indexedDB.open(this.DB_NAME,this.VERSION);a.onerror=()=>t(a.error),a.onsuccess=t=>{this.DB=a.result,e(t)},a.onupgradeneeded=e=>{const t=e.target.result,a=t.objectStoreNames;for(const n of this.DB_STORE)a.contains(n.name)||t.createObjectStore(n.name,{keyPath:n.key})}}),this.save=(e,t)=>new Promise((a,n)=>{const r=this.DB.transaction(e,"readwrite"),i=r.objectStore(e);r.oncomplete=e=>a(e),r.onabort=e=>n(e),Array.isArray(t)?t.forEach(e=>{i.add(e)}):i.add(t)}),this.delete=(e,t)=>new Promise((a,n)=>{const r=this.DB.transaction(e,"readwrite"),i=r.objectStore(e);r.oncomplete=e=>a(e),r.onabort=e=>n(e),Array.prototype.concat([],t).forEach(e=>{i.delete(e)})}),this.update=(e,t)=>new Promise((a,n)=>{const r=this.DB.transaction(e,"readwrite").objectStore(e).put(t);r.onsuccess=e=>a(e),r.onerror=e=>n(e)}),this.getStore=e=>new Promise((t,a)=>{const n=this.DB.transaction(e).objectStore(e).getAll();n.onsuccess=({target:e})=>t(e.result),n.onerror=e=>a(e)}),this.DB_NAME=e.name,this.DB_STORE=e.store,this.VERSION=e.version||1}get(e,t){return new Promise((a,n)=>{const r=this.DB.transaction(e).objectStore(e).get(t);r.onsuccess=({target:e})=>a(e.result),r.onerror=e=>n(e)})}}({name:"fipe_api",store:[{name:"response",key:"url"}]});async function S(e){const t=await M.get("response",e);if(t)return t.response;{const t=await fetch(e);if(!t.ok)throw new Error(t.statusText);const a=await t.json();return M.update("response",{url:e,response:a}),a}}Object(h.f)({enforceActions:"observed"});const T={Valor:"",Marca:"",Modelo:"",AnoModelo:"",Combustivel:"",CodigoFipe:"",MesReferencia:"",TipoVeiculo:0,SiglaCombustivel:""};let D=(u=class{constructor(){Object(d.a)(this,"selectedType",p,this),Object(d.a)(this,"selectedBrand",b,this),Object(d.a)(this,"selectedModel",f,this),Object(d.a)(this,"selectedYear",v,this),Object(d.a)(this,"vehicleBrands",g,this),Object(d.a)(this,"vehicleModels",w,this),Object(d.a)(this,"vehicleYears",E,this),Object(d.a)(this,"vehicle",y,this),Object(d.a)(this,"selectVehicleType",j,this),Object(d.a)(this,"selectBrand",O,this),Object(d.a)(this,"selectModel",B,this),Object(d.a)(this,"selectYear",x,this)}get selectState(){return this.selectedBrand&&this.selectedModel&&this.selectedYear?3:this.selectedBrand&&this.selectedModel?2:this.selectedBrand?1:0}},p=Object(m.a)(u.prototype,"selectedType",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return"carros"}}),b=Object(m.a)(u.prototype,"selectedBrand",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),f=Object(m.a)(u.prototype,"selectedModel",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),v=Object(m.a)(u.prototype,"selectedYear",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),g=Object(m.a)(u.prototype,"vehicleBrands",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),w=Object(m.a)(u.prototype,"vehicleModels",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),E=Object(m.a)(u.prototype,"vehicleYears",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[]}}),y=Object(m.a)(u.prototype,"vehicle",[h.l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return T}}),Object(m.a)(u.prototype,"selectState",[h.e],Object.getOwnPropertyDescriptor(u.prototype,"selectState"),u.prototype),j=Object(m.a)(u.prototype,"selectVehicleType",[h.d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return async e=>{if(this.selectedType=e,this.selectedBrand=void 0,this.selectedModel=void 0,this.selectedYear=void 0,!e)return;const t=await S(`https://parallelum.com.br/fipe/api/v1/${e}/marcas`);Object(h.m)(()=>{this.vehicleBrands=t})}}}),O=Object(m.a)(u.prototype,"selectBrand",[h.d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return async e=>{if(this.selectedBrand=e,this.selectedModel=void 0,this.selectedYear=void 0,console.log(e),!e)return;const t=await S(`https://parallelum.com.br/fipe/api/v1/${this.selectedType}/marcas/${this.selectedBrand}/modelos`);Object(h.m)(()=>{this.vehicleModels=t.modelos})}}}),B=Object(m.a)(u.prototype,"selectModel",[h.d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return async e=>{if(this.selectedModel=e,this.selectedYear=void 0,!e)return;const t=await S(`https://parallelum.com.br/fipe/api/v1/${this.selectedType}/marcas/${this.selectedBrand}/modelos/${this.selectedModel}/anos`);Object(h.m)(()=>{this.vehicleYears=t})}}}),x=Object(m.a)(u.prototype,"selectYear",[h.d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return async e=>{if(this.selectedYear=e,!e)return;const t=await S(`https://parallelum.com.br/fipe/api/v1/${this.selectedType}/marcas/${this.selectedBrand}/modelos/${this.selectedModel}/anos/${this.selectedYear}`);Object(h.m)(()=>{this.vehicle=t})}}}),u);var k=new class{constructor(){this.mainStore=void 0,this.mainStore=new D,M.init().then(()=>{this.mainStore.selectVehicleType("carros")})}};function z(e,t=[]){if(0===t.length)throw new Error("Stores must have at least one store name.");return Object(l.b)(...t)(Object(l.c)(e))}var C=a(43);const N=(...e)=>{const t=[];for(const a of e){let e=typeof a;if("string"===e)t.push(a);else if("object"===e)for(let n in a)a[n]&&t.push(n)}return t.join(" ")};var Y=a(3);const V=z((function({mainStore:{selectedType:e,selectVehicleType:t}}){return r.a.createElement(A,null,r.a.createElement("button",{className:N({active:"motos"===e}),onClick:()=>t("motos")},"Motos"),r.a.createElement("button",{className:N({active:"carros"===e}),onClick:()=>t("carros")},"Carros"),r.a.createElement("button",{className:N({active:"caminhoes"===e}),onClick:()=>t("caminhoes")},"Caminh\xf5es"))}),["mainStore"]);const A=Y.a.div`
  display: flex;
